...
public class VerifyCodeUtil {
	...
	public static void main(String[] args) throws IOException {
		...
		//90, 30
		//String textCode, int width, int height, int interLine, boolean randomLocation, Color backColor, Color foreColor, Color lineColor
		BufferedImage bufferedImage = generateImageCode(verifyCode, 600, 200, 10, true, Color.WHITE, Color.BLACK, null);
		ImageIO.write(bufferedImage, "JPEG", new File("C:/Users/admin/Desktop/aa.jpg"));
	}
}