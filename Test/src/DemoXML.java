...
public class DemoXML {
    ...
    public static void queryXml(){
        ...
        try{
            ...
            //把要解析的xml文档读入DOM解析器
            Document doc = dbBuilder.parse("E:\\dblp.xml");
            ...
            for(int i = 0; i< nList.getLength() ; i ++){
                ...
                System.out.println("pages: "+ node.getElementsByTagName("pages").item(0).getFirstChild().getNodeValue());
                System.out.println("volume: "+ node.getElementsByTagName("volume").item(0).getFirstChild().getNodeValue());
                System.out.println("journal: "+ node.getElementsByTagName("journal").item(0).getFirstChild().getNodeValue());
                System.out.println("number: "+ node.getElementsByTagName("number").item(0).getFirstChild().getNodeValue());
                System.out.println("url: "+ node.getElementsByTagName("url").item(0).getFirstChild().getNodeValue());
                System.out.println("ee: "+ node.getElementsByTagName("ee").item(0).getFirstChild().getNodeValue());
            }
