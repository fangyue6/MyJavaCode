...
<div class="body-box" style="float:right">
	...
	<input type="hidden" value="${achieve.id}" name="id"></input>
			...
			<input type="hidden" name="studentNumber" value="${student.studentNumber }"></input>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" style="width: 600px" required class="required" name="title" maxlength="200" value="${achieve.title }"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<a href="${achieve.essay1 }"  target="view_window" id="downloadessay">查看</a>
					</td>
				</tr>
 				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<input type="hidden" name="essay" id="essaypath" value="${achieve.essay}"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<a href="${achieve.code1 }" target="view_window" id="downloadcode">查看</a>
					</td>
				</tr>
 				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<input type="hidden" name="code" id="codepath" value="${achieve.code}"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="date" class="required" name="time" maxlength="80" value="${achieve.time }"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						成果描述:</td><td width="80%" class="pn-fcontent">
						<textarea rows="4" cols="50" name="describe" >${achieve.describe }</textarea>
					</td>
				</tr>
			</tbody>
			<tbody>
