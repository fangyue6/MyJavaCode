...
<script type="text/javascript" src="/record/res/fckeditor/fckeditor.js"></script>
                     ...
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <img src="/res/itcast/img/admin/welconlogin-icon.png"/><span id="welcome">您好:
                                    <c:if test="${!empty sessionScope.superadmin}">${sessionScope.superadmin.name}</c:if>
                                    <c:if test="${empty sessionScope.superadmin}">${student.name}</c:if>
                                    </span>
                                    <img src="/res/itcast/img/admin/loginout-icon.png"/><a href="../user/logout.do?returnUrl=/index.shtml" target="_top" id="logout" onclick="return confirm('您确定退出吗?');">退出</a> 
                                    <!-- <img src="/record/res/itcast/img/admin/message-unread.png"/>&nbsp;<a href="message/v_list.do" target="rightFrame">你有<span id="countDiv">0</span>条信息未读</a> -->
                                    </td>
                                  </tr>
                                </table>
                       </div>  
                     <div class="nav">
                     	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
                                    	<li class="current" id="tb_11" onclick="HoverLi(11);"><a href="main.do" target="mainFrame">关于我</a></li>
