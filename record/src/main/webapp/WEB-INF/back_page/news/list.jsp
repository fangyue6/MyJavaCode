...
<body>
	<div class="box-positon">
		<div class="rpos">当前位置: 新闻管理 - 列表</div>
		<form class="ropt">
			...
			<tbody class="pn-ltbody">
				...
				<c:forEach items="${pagination.list }" var="entry">
					...
					<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'"
						...
						<td align="center" width="15%">${entry.title }</td>
						<td align="center" width="25%"> ${entry.abstracts }</td>
						<td align="center" width="8%">${entry.reporter }</td>
						<td align="center" width="15%">${entry.reporttitle }</td>
						<td align="center" width="15%">${entry.organizer }</td>
